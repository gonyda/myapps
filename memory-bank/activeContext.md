...
- [x] **마나 30 포션(`mp_potion_30`) & 스태미나 30 포션(`stamina_potion_30`) 아이템 추가 및 포션 시스템 확장 (5대 가드레일 통과)**
- [x] **알비 던전 클리어 보상 확률형 드랍 개편 (숏소드 20% 1개, HP/MP/스태미나 포션 각 독립 50% 1~3개) 및 5대 가드레일 1025개 테스트 통과**
