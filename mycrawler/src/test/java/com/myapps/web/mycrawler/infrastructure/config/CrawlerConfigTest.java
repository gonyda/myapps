...
class CrawlerConfigTest {
    ...
    void should_returnEmptyList_when_targetsIsNull() {
        final CrawlerConfig config = new CrawlerConfig(VALID_CRON, VALID_TIMEOUT, VALID_BROWSERS_PATH, null);
    ...
    void should_returnEmptyList_when_targetsIsEmpty() {
        final CrawlerConfig config = new CrawlerConfig(VALID_CRON, VALID_TIMEOUT, VALID_BROWSERS_PATH, List.of());
