...
class AdminControllerTest {
    ...
    void should_includeTargetsInModel_when_getAdminRequested() throws Exception {
        final List<CrawlTarget> targets = List.of(
                new CrawlTarget("fmkorea-stock", "https://fmkorea.com/stock"),
                new CrawlTarget("wepoll-stock", "https://wepoll.kr/g2/bbs/board.php?bo_table=stock")
        );
    ...
    void should_setSuccessFlash_when_executeSingleReturnsResult() throws Exception {
        ...
        final CrawlResult result = new CrawlResult(
                targetName, "https://fmkorea.com/stock",
                CrawlStatus.SUCCESS, TriggerSource.MANUAL,
                "<html>content</html>", null, now, now.plusSeconds(3)
        );
