...
- [ ] 1. myrpg 모듈 스캐폴딩 및 빌드 설정
  - [ ] 1.1 myrpg/pom.xml 생성 및 Parent POM 모듈 등록
...
- [ ] 3. JPA 엔티티 및 리포지터리 구현
  - [ ] 3.1 rpg_ 접두사 JPA 엔티티 작성
  ...
  - [ ] 3.2 Spring Data JPA 리포지터리 인터페이스 작성
...
- [ ] 5. RandomSource 추상화 구현
  - [ ] 5.1 RandomSource 인터페이스 및 운영 구현 작성
...
- [ ] 7. CharacterService (스탯·레벨업·페널티) 구현
  - [ ] 7.1 CharacterService 구현
  ...
  - [ ] 7.5 초기 캐릭터 생성 단위 테스트 작성
    - Lv1/HP100/MP50/공10/방5/속5/치0/exp0/gold0 초기값 검증
    - _Requirements: 1.1_

- [ ] 8. BattleService (데미지·치명타·선후공·자원) 구현
  - [ ] 8.1 BattleService 구현
...
- [ ] 9. DropService (드랍 롤) 구현
  ...
  - [ ] 9.4 드랍 카테고리·풀·독립 인스턴스 속성 테스트 작성
...
- [ ] 10. DungeonService (스테이지·이벤트·보물) 구현
  - [ ] 10.1 DungeonService 구현
  ...
  - [ ] 10.2 스테이지 이벤트·몬스터 선택 속성 테스트 작성
...
- [ ] 12. EquipmentService (착용·스킬 장착 불변식) 구현
  - [ ] 12.1 EquipmentService 구현
...
- [ ] 13. Checkpoint - 도메인 규칙 서비스 검증
  - 모든 규칙 서비스 속성/단위 테스트가 통과하는지 확인하고, 의문이 생기면 사용자에게 질문한다.

- [ ] 14. 애플리케이션 오케스트레이션 구현
  - [ ] 14.1 GameSessionService 구현
...
- [ ] 17. Final Checkpoint - 전체 테스트 및 빌드 검증
