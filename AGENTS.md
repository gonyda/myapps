...
> **AI 에이전트는 교체 가능하게, 개발 프로세스는 일관되게, 프로젝트 지식은 지속되게, 코드 품질은 자동으로 검증되게**

---

## 1. 아키텍처 철학

이 프로젝트는 **AI Agent가 교체 가능한(Swappable) 아키텍처**로 설계되었습니다.  
**Kiro**, **Cline**, **Antigravity** 등 어떤 AI 도구를 사용하더라도 프로젝트의 규칙, 맥락, 프로세스가 단절되지 않고 동일한 환경에서 동작합니다.
