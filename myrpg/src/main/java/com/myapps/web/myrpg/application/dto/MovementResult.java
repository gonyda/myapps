 ...
 *
 * <p>정상 흐름은 예외를 던지지 않으며, 이동 불가/준비 중은 "정상적 거부"로 처리한다.
 * 허용되는 구현체는 {@link Moved}, {@link Blocked}, {@link DungeonLocked}이다.
 */
public sealed interface MovementResult permits MovementResult.Moved, MovementResult.Blocked, MovementResult.DungeonLocked {
