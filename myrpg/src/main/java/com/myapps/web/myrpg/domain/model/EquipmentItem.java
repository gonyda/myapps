 ...
 *
 * <p>무기({@link ItemType#WEAPON}) 또는 방어구({@link ItemType#ARMOR})이며,
 * 장비 종류({@link EquipmentKind})에 따라 착용 슬롯이 결정된다.
 * 보너스({@link EquipBonus})는 STAT/VITAL 계열로 분기되어 캐릭터 스탯에 합산된다.
 *
 * <p>{@code buyPrice}는 7순위 상점 스펙에서 실제 구매 처리가 확정된다.
