 ...
 * 게임 내 시간대를 나타내는 열거형.
 *
 * <p>각 상수는 key 문자열과 반열린 구간 {@code [from, to)}을 내장하여
 * 시간대 정보의 단일 소스 역할을 한다.
 * 6개의 구간이 {@code [0, 24)}을 빈틈 없이 분할하므로,
 * 0~23 범위의 모든 시(hour)는 정확히 하나의 시간대에 대응한다.
 */
public enum TimeOfDay {
     ...
     *
     * <p>6개의 구간이 {@code [0, 24)}을 빈틈 없이 분할하므로,
     * 0~23 범위의 시는 항상 정확히 하나의 상수에 대응한다.
     *
