 ...
 *
 * <p>일반(NORMAL) &gt; 강(HEAVY) &gt; 방어(DEFENSE) &gt; 일반(NORMAL) 순환 상성을 따르며,
 * 동일 타입은 DRAW를 반환한다. 인스턴스를 생성하지 않는 정적 메서드만 제공한다.
 */
public final class RockPaperScissors {
     ...
     * <p>상성 규칙:
     * <ul>
     *   <li>일반(NORMAL) &gt; 강(HEAVY): 일반 승리</li>
     *   <li>강(HEAVY) &gt; 방어(DEFENSE): 강 승리</li>
     *   <li>방어(DEFENSE) &gt; 일반(NORMAL): 방어 승리</li>
     *   <li>동일 타입: 무승부(DRAW)</li>
     * </ul>
     *
     * @param mine  자신의 스킬 타입
     * @param other 상대의 스킬 타입
     * @return 자신 기준 상성 결과 ({@link AffinityResult#WIN}, {@link AffinityResult#LOSE}, {@link AffinityResult#DRAW})
     */
