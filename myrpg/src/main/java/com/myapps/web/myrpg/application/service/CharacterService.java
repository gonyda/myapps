...
public class CharacterService {
     ...
     *
     * <p>저장소가 비어 있으면 닉네임 "고니", Base_Stats, Lv1/누적1/EXP0,
     * 시작 노드 "tir-chonaill"의 기본 캐릭터를 정확히 1개 생성하여 저장합니다.
     * 저장소에 1개 이상의 레코드가 존재하면 기존 진행상황을 반환합니다.
     *
    ...
    private CharacterProgress createAndSaveDefault() {
        ...
        try {
            return characterProgressRepository.save(defaultCharacter);
        } catch (final Exception exception) {
