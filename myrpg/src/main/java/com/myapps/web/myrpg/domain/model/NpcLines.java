 ...
 *
 * <p>기본 대사 목록과 시간대별 추가 대사 맵을 보관한다. 대사 선택 시 {@code defaultLines}와 현재 시간대에 해당하는 {@code byTime} 항목을
 * 병합하여 후보 풀을 구성한다.
 *
...
public record NpcLines(
        @JsonProperty("default") List<String> defaultLines, Map<String, List<String>> byTime) {}
