 ...
 *
 * <p>플레이어와 몬스터 양측의 행동·피해, 각종 판정 플래그(크리티컬/방어/반격/캐스팅 실패/
 * 선제/자원 부족), 전투 종료 여부 및 결과, 보상 정보, 활동 로그를 포함한다.
 * {@link BattleTurnResult.Outcome}으로 전투 종료 유형을 구분한다.
 *
 ...
 * @param logLines            이 턴의 활동 로그 라인 목록
 */
