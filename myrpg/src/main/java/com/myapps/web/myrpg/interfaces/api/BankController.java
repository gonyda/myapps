...
public class BankController {
    ...
    public String bank(final Model model) {
        final BankView view = buildBankView();
     ...
     */
    @PostMapping("/deposit")
    public String deposit(@RequestParam final long amount, final Model model) {
    ...
    public String withdraw(@RequestParam final long amount, final Model model) {
        final CharacterProgress progress = characterService.loadOrCreateDefault();
    ...
    public String depositItem(@RequestParam final long ownedItemId, final Model model) {
    ...
    public String withdrawItem(@RequestParam final long ownedItemId, final Model model) {
     ...
     * @return 은행 팝업 뷰 모델
     */
    private BankView buildBankView() {
        final CharacterProgress progress = characterService.loadOrCreateDefault();
        final Bank bank = bankService.loadOrCreateDefault();
        return inventoryService.buildBankView(progress.getGold(), bank.getGold());
    }
}
