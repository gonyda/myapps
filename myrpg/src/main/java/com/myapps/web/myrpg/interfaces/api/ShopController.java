...
public class ShopController {
     ...
     *
     * <p>NPC 판매 목록 포함 및 buyPrice 존재를 검증한 뒤 골드를 차감하고 인벤토리에 아이템을 추가한다. 골드 부족 시 {@code
     * InsufficientGoldException}, 인벤토리 초과 시 {@code InventoryFullException}이 발생하여 {@code
     ...
     *
     * <p>장착 중인 장비는 {@code EquipConflictException}으로 거부되어 {@code GlobalExceptionHandler}에서 처리된다.
     *
     * @param npcId 대화 중인 NPC ID (없으면 빈 구매 목록)
