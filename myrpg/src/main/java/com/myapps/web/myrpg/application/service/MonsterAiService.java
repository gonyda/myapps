 ...
 * 몬스터 가위바위보 AI 서비스.
 *
 * <p>몬스터의 전투 행동을 확률적으로 결정한다. 일반(NORMAL) 34%, 강(HEAVY) 33%, 방어(DEFENSE) 33%의 고정 분포를 사용하며, 몬스터별 개별
 * 가중치 override는 없다.
 */
@Service
public class MonsterAiService {
     ...
     *
     * <ul>
     *   <li>0 ~ 33 (34개): {@link SkillType#NORMAL}
     *   <li>34 ~ 66 (33개): {@link SkillType#HEAVY}
     *   <li>67 ~ 99 (33개): {@link SkillType#DEFENSE}
     * </ul>
     *
     ...
     *
     * <p>이 메서드의 반환값은 6순위(전투 턴) 구현에서 실제 데미지 계산에 소비된다. 6순위에서 전투 상태 머신이 이 메서드를 호출하여 몬스터 행동을 결정하고, 행동별
     * 배율과 플레이어 방어를 조합하여 최종 데미지를 산출한다.
     *
