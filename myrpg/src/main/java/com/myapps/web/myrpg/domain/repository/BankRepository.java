 ...
 *
 * <p>Spring Data JPA를 활용하여 기본 CRUD와 은행 행 로드 기능을 제공한다.
 * 싱글 플레이어 구조로 id 오름차순 첫 번째 레코드가 유일한 은행 금고이다.
 */
public interface BankRepository extends JpaRepository<Bank, Long> {
     ...
     *
     * <p>싱글 플레이어 게임 구조에서 유일한 은행 금고를 로드할 때 사용한다.
     * 저장된 행이 없으면 빈 Optional을 반환한다.
     *
