...
public record MapNode(
     ...
     */
    public MapNode(final String id, final String name, final String type,
                   final NodeType nodeType, final int x, final int y,
                   final String dungeonId, final String theme, final List<String> links) {
