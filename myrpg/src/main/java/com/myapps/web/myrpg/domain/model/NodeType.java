 ...
 * 맵 노드의 유형을 나타내는 열거형.
 *
 * <p>알려진 값은 {@code TOWN}, {@code FIELD}, {@code DUNGEON}이며,
 * 알 수 없는 타입 문자열은 일반 통행 노드로 취급한다.
 * 새로운 유형 추가 시 기존 로직을 깨지 않도록 확장 가능한 형태로 설계되었다.
 */
public enum NodeType {
     ...
     *
     * <p>알 수 없는 타입 문자열은 빈 {@code Optional}을 반환하며,
     * 이 경우 해당 노드는 일반 통행 노드로 취급한다.
     *
