 ...
 *
 * <p>외부 의존성 없이 {@link MapGraph}와 현재 노드 정보만으로 뷰 렌더링에 필요한 격자 셀과 간선 정보를 산출한다. 현재 노드 id가 그래프에 존재하지 않으면
 * {@link MapViewGenerationException}을 던진다.
 */
public class MapViewFactory {
    ...
    private boolean hasMinimapLink(
        ...
        final Optional<MapNode> neighborOpt =
                graph.byCoord(MapGraph.coordKey(neighborX, neighborY));
