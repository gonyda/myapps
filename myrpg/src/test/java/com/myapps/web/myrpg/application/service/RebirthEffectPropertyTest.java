 ...
 *
 * <p>환생 가능한 캐릭터에 대해 {@code rebirth} 호출 후:
 * level=1, exp=0, 누적+1, 재능 MELEE, lastRebirthAt=now, 풀회복,
...
class RebirthEffectPropertyTest {
    ...
    void should_resetToBaseState_when_rebirthSucceeds(
        ...
        final long experience = level < 100
                ? experiencePolicy.requiredForNext(level) - 1
                : 0L;
        ...
        assertThat(baseStats.str())
                .as("레벨 1 STR은 기본값 10이어야 한다")
                .isEqualTo(10);
        assertThat(baseStats.dex())
                .as("레벨 1 DEX는 기본값 10이어야 한다")
                .isEqualTo(10);
        assertThat(baseStats.intelligence())
                .as("레벨 1 INT는 기본값 10이어야 한다")
                .isEqualTo(10);
        assertThat(baseStats.critical())
                .as("레벨 1 Critical은 기본값 50이어야 한다")
                .isEqualTo(50);
        assertThat(baseStats.defense())
                .as("레벨 1 DEF는 기본값 5이어야 한다")
                .isEqualTo(5);
    }
