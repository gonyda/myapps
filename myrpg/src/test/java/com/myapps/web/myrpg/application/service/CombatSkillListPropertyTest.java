 ...
 * 전투 스킬 목록 프로퍼티 테스트.
 *
 * <p>임의의 착용 무기와 스킬 카탈로그에 대해, {@code combatSkills}가 착용 무기 재능 스킬 + 공통 스킬(방어)만 포함하고 다른 재능 스킬은 제외하며, 무기
 * 변경 시 목록이 그에 맞게 바뀌는지 검증한다.
 *
...
class CombatSkillListPropertyTest {
    ...
    void should_includeOnlyMatchingTalentAndCommon_when_weaponEquipped(
        ...
        final OwnedItem weapon =
                new OwnedItem("weapon_1", 1, StorageKind.INVENTORY, true, MAX_DURABILITY);
        final EquipmentItem weaponCatalog =
                new EquipmentItem(
                        "weapon_1",
                        "무기",
                        ItemType.WEAPON,
                ...
                .thenReturn(
                        Optional.of(
                                createDamageSkill(
                                        ...
                                        SkillType.NORMAL,
                                        SkillTalent.MELEE)));
        when(skillCatalogService.byId("archery_normal"))
                .thenReturn(
                        Optional.of(
                                createDamageSkill(
                                        "archery_normal",
                                        ...
                                        SkillType.NORMAL,
                                        SkillTalent.ARCHERY)));
        when(skillCatalogService.byId("magic_normal"))
                .thenReturn(
                        Optional.of(
                                createDamageSkill(
                                        "magic_normal",
                                        ...
                                        SkillType.NORMAL,
                                        SkillTalent.MAGIC)));
        when(skillCatalogService.byId("defense"))
                .thenReturn(Optional.of(createDefenseSkill("defense", "방어", SkillTalent.COMMON)));
    ...
    void should_changeSkillList_when_weaponChanges(
        ...
        final OwnedItem firstWeapon =
                new OwnedItem("weapon_first", 1, StorageKind.INVENTORY, true, MAX_DURABILITY);
        final EquipmentItem firstCatalog =
                new EquipmentItem(
                        "weapon_first",
                        "첫무기",
                        ItemType.WEAPON,
        ...
        final OwnedItem secondWeapon =
                new OwnedItem("weapon_second", 1, StorageKind.INVENTORY, true, MAX_DURABILITY);
        final EquipmentItem secondCatalog =
                new EquipmentItem(
                        "weapon_second",
                        "두번째무기",
                        ItemType.WEAPON,
    ...
    private DamageSkill createDamageSkill(
            final String id, final String label, final SkillType type, final SkillTalent talent) {
    ...
    private DefenseSkill createDefenseSkill(
            final String id, final String label, final SkillTalent talent) {
