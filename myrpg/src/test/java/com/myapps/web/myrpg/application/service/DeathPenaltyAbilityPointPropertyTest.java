 ...
 *
 * <p>임의의 레벨(1~100), 임의의 AP(0~200), 임의의 경험치, 임의의 재능을 가진 캐릭터에 사망 패널티를 적용해도 보유 AP는 변하지 않아야 한다.
 *
...
class DeathPenaltyAbilityPointPropertyTest {
    ...
    void should_keepAbilityPointsUnchanged_when_deathPenaltyApplied(
        ...
        // Then: AP는 변하지 않아야 한다
        assertThat(progress.getAbilityPoints()).as("사망 패널티 후 AP는 불변이어야 한다").isEqualTo(apBefore);
    }
