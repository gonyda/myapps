 ...
 *
 * <p>{@code hitCount == 1}이고 {@code critBonus == 0}인 딜 스킬에 대해, {@link
 * BattleResolver#multiHitDamage}의 단일 결과와 총 피해가 009 이전 단일 {@link BattleResolver#finalDamage} 산출과 동일한
 * 값(동일 난수 시퀀스)을 내는지 검증한다.
 *
...
class BattleResolverSingleHitBackwardCompatPropertyTest {
     ...
     *
     * <p>동일 시드의 두 BattleResolver를 만들어, 하나는 multiHitDamage를 호출하고, 다른 하나는 직접
     * rollCritical→finalDamage를 호출하여 결과를 비교한다.
     *
     * @param seed 난수 시드
