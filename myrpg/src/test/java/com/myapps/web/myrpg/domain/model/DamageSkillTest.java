 ...
 *
 * <p>7-인자 하위호환 보조 생성자가 hitCount=1, critBonus=0을 기본 설정하는지, 9-인자 정규 생성자가 모든 필드를 올바르게 보존하는지 확인한다.
 */
class DamageSkillTest {
    ...
    private Map<SkillRank, Integer> buildMonotonicRankMap(
            final int startValue, final int increment) {
