...
class SkillControllerTest {
    ...
    /**
     * POST /skills/{id}/rankup 성공 시 갱신된 승급 모달이 반환되고
     * 캐릭터 진행상황이 저장되는지 검증한다.
     */
    @Test
    ...
    /**
     * POST /skills/{id}/rankup 시 AP 부족이면 {@link InsufficientAbilityPointsException}이
    ...
    private SkillListView dummyListView(final String activeTab) {
        final SkillRowView row = new SkillRowView(
                SKILL_ID, "윈드밀", "근접전투", "F", 0, false, false
        );
