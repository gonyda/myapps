...
class SkillRankPolicyTest {
    ...
    @Test
    @DisplayName("F→E 승급 요구치: usage=5, apCost=1")
    ...
    @Test
    @DisplayName("1→Master 승급 요구치: usage=5000, apCost=34")
    ...
    @Test
    @DisplayName("궁극기 승급 요구치: F랭크 1회, 1랭크 20회")
    ...
    @Test
    @DisplayName("requirementFor: PASSIVE는 usage=0 즉시 승급 반환")
