 ...
 *
 * <p>MonsterService, MonsterDialogueService, MonsterAiService, MonsterRewardService,
 * MonsterEncounterService가 정상적으로 빈으로 등록되고 카탈로그 로드까지 완료되는지 확인합니다.
 */
@SpringBootTest
